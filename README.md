...
An utterly fantastic facebook messenger bot to give real time updates of Training and Placement portal of IIT (BHU) [link](https://placement.iitbhu.ac.in/) to the students. The bot periodically crawls the `company's visit` page and sends private text messages to registered users about the new companies arrivals according to their branch and course.
